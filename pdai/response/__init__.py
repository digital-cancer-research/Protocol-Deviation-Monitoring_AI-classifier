...
class QAResponseCategory(BaseModel):
    ...
    LABEL_SPACE: ClassVar[Dict] = {
        "ASSESSMENT OR TIME POINT COMPLETION": [
            ...
            "MISSED ASSESSMENT - EFFICACY ASSESSMENT",
            "MISSED ASSESSMENT - ECG",
            "MISSED ASSESSMENT - VITAL SIGNS",
            "MISSED ASSESSMENT - BLOODS LOCAL",
            "MISSED ASSESSMENT - BLOODS CENTRAL",
            ...
            "UNCATEGORISED - ASSESSMENT OR TIME POINT COMPLETION",
        ],
        "ELIGIBILITY CRITERIA NOT MET": [
            "ELIGIBILITY CRITERIA NOT MET",
            "UNCATEGORISED - ELIGIBILITY CRITERIA NOT MET",
        ],
        "EXCLUDED MEDICATION, VACCINE OR DEVICE": [
            ...
            "UNCATEGORISED - EXCLUDED MEDICATION, VACCINE OR DEVICE",
        ],
        "FAILURE TO REPORT SAFETY EVENTS PER PROTOCOL": [
            ...
            "PREGNANCY",
            "OTHER",
            "UNCATEGORISED - FAILURE TO REPORT SAFETY EVENTS PER PROTOCOL",
        ],
        "INFORMED CONSENT": [
            ...
            "UNCATEGORISED - INFORMED CONSENT",
        ],
        "NOT WITHDRAWN AFTER DEVELOPING WITHDRAWAL CRITERIA": [
            ...
            "UNCATEGORISED - NOT WITHDRAWN AFTER DEVELOPING WITHDRAWAL CRITERIA",
        ],
        "STUDY PROCEDURE": [
        ...
        "WRONG STUDY TREATMENT/ADMINISTRATION/DOSE": [
            ...
            "UNCATEGORISED - WRONG STUDY TREATMENT/ADMINISTRATION/DOSE",
        ],
        "SITE LEVEL ERROR": [
            ...
            "UNCATEGORISED - SITE LEVEL ERROR",
        ],
        "UNCATEGORISED": [
